...
VALUES
('dunder', 'dunder@mifflin.com', '$2y$04$bme5r.P/TsLCUzU5dQSxYuxPK2FU06D8pZGIa.P6bIGeF1KgyJCNC'),
('admin', 'admin@admin.admin', '$2y$12$MIVZHt0G9wkA4Rqf8NSFpuLtX/x.Xryn5qC.Ss5M2BlnpOa.2bo.O');

INSERT INTO JURPS_characters(name, race, cclass, strength, dexterity, intelligence, health, hit_points, will, perception, fatigue_points, user_id)
VALUES
('Lur, of Omicron Persei 8','Omicronian','Ruler',20,7,10,18,50,8,7,14,1),
...
('Cthulu','Old One','Great Old One',50,50,50,50,400,50,50,50,1),
